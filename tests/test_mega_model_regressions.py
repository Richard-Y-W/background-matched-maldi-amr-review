...
class MegaModelRegressionTests(unittest.TestCase):
    ...
    def test_gpu_cache_lookup_avoids_eager_default(self):
        source = read_source()
    ...
    def test_ablation_uses_screened_active_pairs(self):
    ...
    def test_training_warnings_are_configured(self):
        source = read_source()
