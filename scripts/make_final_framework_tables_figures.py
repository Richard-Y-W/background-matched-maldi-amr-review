...
the bundled project runtime. It reads the already-generated audit outputs and writes
publication CSV/Markdown tables plus PNG figures.
"""
...
def write_summary(tables: dict[str, pd.DataFrame], figure_paths: list[Path]) -> None:
    ...
    lines = [
        ...
        "",
        "- Table 1: primary background-matched audit with bootstrap CIs and adequacy labels.",
