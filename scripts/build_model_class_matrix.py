...
- E. coli expanded-panel LGBM multi-task background audit.
...
python run_background_audit_framework.py \\
  --predictions-csv /kaggle/working/lgbm_exports/ecoli/lgbm_multi_predictions_long.csv \\
  --background-signature-col background_signature \\
  --model-name LGBM-multi-ecoli6 \\
  --output-dir /kaggle/working/ecoli_lgbm_multi_background_audit
```
