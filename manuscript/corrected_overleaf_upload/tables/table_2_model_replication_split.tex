...
\centering
\scriptsize
\caption{Alternative split-column model-family replication for the primary E. coli contrast.}
\label{tab:model-replication-split}
\resizebox{\linewidth}{!}{%
...
\vspace{2mm}\parbox{0.95\linewidth}{\footnotesize This alternate layout separates raw and background-centered AUC columns for direct model-family comparison. Asterisks mark caution rows with low matched support.}
\end{table}
